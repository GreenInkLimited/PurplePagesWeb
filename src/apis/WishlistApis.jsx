...
export const getWishlist = async () => {
  ...
  const response = await axios.get(`${API.host}/wishlist/all/product/${auth_code}/`);
...
export const getBlogWishlist = async () => {
  ...
  const response = await axios.get(`${API.host}/wishlist/all/blog/${auth_code}/`);
  return response.data;
};
