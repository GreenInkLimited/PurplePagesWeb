  ...
  return (
    ...
    <div className="wishlist-container  container">
      <div className="wishlist__bloc-tabs">
        <h4>Wishlist</h4>
        <button
          className={toggleState === 1 ? "wishlist__tabs active-wishlist__tabs" : "wishlist__tabs"}
          onClick={() => toggleTab(1)}
        >
          Products
        </button>
        <button
          className={toggleState === 2 ? "wishlist__tabs active-wishlist__tabs" : "wishlist__tabs"}
          onClick={() => toggleTab(2)}
        >
          Blogposts
        </button>
      ...
      <div className="wishlist__content-tabs">
          ...
          <div className={toggleState === 1 ? "wishlist__contentx  active-wishlist__content" : "wishlist__contentx"}>
        ...
        <div
          className={toggleState === 2 ? "wishlist__contentx  active-wishlist__content" : "wishlist__contentx"}
        >
          <div className="first__wishlist-content">
          <h3>Blogposts</h3>
          <div className='first__wishlist-share'>
