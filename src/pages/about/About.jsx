    ...
    <header className='about__header'>
        <div className="about__header__container">
            ...
            <div className="about__header__content">
                <h2>About Us</h2>
                <p>The platform that supports SMEs in effortlessly reaching a larger audience and achieving business growth.</p>
            </div>
        </div>
    </header>
        ...
        <div className="container pillars">
          ...
          <div className="pillars__values__container">
            ...
            <div className='pillars__values__wrapper'>
              ...
              <p>Our main goal is to support SME growth and profitability by offering business solutions that will make doing business easier.</p>
              </div>
             <div>
             <div className="pillars__icon">
    ...
    <div className="core__values__container">
      ...
      <div className="core__values__right ">
                ...
                <div className='core__values__wrapper'>
                    <h4>Trust</h4>
                    <p>We act with integrity and honour our commitments. We operate transparently and promote corporate social responsibility. We strive to earn the trust of our customers.</p>
                </div>

                <div className='core__values__wrapper'>
                    <h4>Customer & Market Excellence</h4>
                    <p>We foster innovation, creativity, and technical/operational knowledge. We strive for continuous improvement and excellence at every touch point with our customers. We want to be the benchmark!</p>
                </div>

                <div className='core__values__wrapper'>
                    <h4>Inclusion</h4>
                    <p>We recognize that we are here to serve our customers, and as a result, we solicit their feedback and involve them in the process at every stage of product development and service delivery. We promote inclusivity.</p>
                </div>
