...
import PlanDetailsModal from './PlanDetailsModal.jsx';
  ...
  return (
    <>
      {showPlanDetailsModal ? (
        <PlanDetailsModal selectedPlan={selectedPlan} onCloseModal={handleClosePlanDetailsModal} businessId={id}/>
      ) : (
                ...
                <div className='promote__modal-content right'>
                  <div className='promote__content-container'>
                    ...
                    <div className='promote__plan-packs'>
                      ...
                      <small><BsCheck2Circle /> Featured in one location</small>
                    </div>
                    <div className='promote__button-container'>
                      <button className='promote__button' onClick={handleGetStarted} businessId={id}>Get started</button>
                    </div>
                  </div>
                </div>
                <div className='promote__modal-content left'>
                  <div className='promote__content-container'>
                    ...
                    <div className='promote__plan-packs'>
                      ...
                      <small><BsCheck2Circle /> Access to AI generated designs</small>
                    </div>
                    <div className='promote__button-container'>
                      <button className='promote__button' onClick={handleGetStarted} businessId={id}>Get started</button>
                    </div>
