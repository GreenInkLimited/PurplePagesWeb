    ...
    <div className="modal__background-signout ">
      <div className="create__business-container-signout">
        ...
        <div className="promote__button-containerxx">
               ...
               <button className="user_user__button__cancel" type="button" onClick={closeModal}>
              Cancel
              </button>
              <button className="user_user__button__signout" type="button" onClick={handleSignOut}>
              Sign Out
              </button>
              </div>
        </div>    
