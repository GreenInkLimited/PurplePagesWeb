...
const HostEventDetail = ({ onNext, formData }) => {
  ...
  const categories = ["House Party", "Food & Drink", "Concert", "Business", "Tech", "SMEs", "Dinner", "Seminar"]
          ...
          <div className='persornal__account__main-form'>
            <Formik initialValues={initialValues} onSubmit={handleSubmit}>
              <Form>
                ...
                <Field name="event_category" className="input">
                  {({ field }) => (
                    <div className="dropdownx">
                      ...
                      >
                        {selectedCategory || field.value || "Select Category"} {/* Add the placeholder text */}
                ...
                <label>Upload event flier <small>(required)</small></label>
                <div className="upload__file-containerx" onClick={() => document.querySelector('.logo-input').click()}>
                  <Field
                  ...
                  />
                  {previewURL ? (
                    <img src={previewURL} alt={fileName} className="myuploaded-image" />
                  ) : (
                ...
                <label>Event Frequency <small>(required)</small></label>
  ...
  {({ field }) => (
    <div className="dropdownx">
      ...
      >
        {selectedFrequency || field.value || "Select Frequency"} {/* Add the placeholder text */}
        <div className="dropdown-icons">
        {isActiveFrequency ? <RiArrowUpSLine className="dropdown-icon"/> : <RiArrowDownSLine className="dropdown-icon"/>}
        </div>
      </div>
      {isActiveFrequency && (
        <div className="dropdown-content">
                ...
                {selectedFrequency === "One Time" && (
                  <>
                    <div className='create__business__rowxyz'>
                      <div>
                        <label>From <small>(required)</small></label>
        ...
        > <RiCalendar2Line/></button>
                ...
                <Field name="frequency" className="input">
                  {({ field }) => (
                    <div className="dropdownx">
                      ...
                      >
                        {selectedFreq || field.value || "Select Frequency"} {/* Add the placeholder text */}
                        <div className="dropdown-icons">
                          {isActiveFreq ? <RiArrowUpSLine className="dropdown-icon" /> : <RiArrowDownSLine className="dropdown-icon" />}
                        </div>
                      </div>
                      {isActiveFreq && (
                        <div className="dropdown-content">
                ...
                {selectedFreq !== "Daily" && (
                  <>
                <label>Days <small>(required)</small></label>
                <Field name="days" className="input">
                  {({ field }) => (
                    <div className="dropdownx">
                      ...
                      >
                        {selectedDays || field.value || "Select Day"} {/* Add the placeholder text */}
                        <div className="dropdown-icons">
                          {isActiveDays ? <RiArrowUpSLine className="dropdown-icon" /> : <RiArrowDownSLine className="dropdown-icon" />}
                        </div>
                      </div>
                      {isActiveDays && (
                        <div className="dropdown-content">
