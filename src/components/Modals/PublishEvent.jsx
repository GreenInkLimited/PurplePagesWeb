...
const PublishEvent = ({ onNext, onPrev, onSubmit, formData, hostEventDetail }) => {
    ...
    <div className='personal__account__form-container'>
      ...
      <div className='persornal__account__form-wrapper'>
        ...
        <div className='persornal__account__main-form'>
          ...
          <p>Review your event or click on publish to make your event public</p>
          </div>
          <div className="stepper__form-event__details">
            ...
            <div className="stepper__form-event__details-right">
              ...
              <p>{formData.from_date} - {formData.to_date}</p>
              </div>
              ) : (
                <div className='preview__your-event'>
                  <RiCalendarEventFill className='preview__your-event-icon'/>
                <p>{formData.days}, {formatDate(formData.end_date)}</p>
                </div>
              )}
              <div className='preview__your-event'>
        ...
        <button className='personal__input button' type='submit' onClick={onSubmit}> Publish your event</button>
        <br/><br/>
      </div>
    </div>
    </div>
