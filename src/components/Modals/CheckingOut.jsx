         ...
         <div className='checkout__body-left'>
            <div className='accordionx'>
              <div className='itemx'>
                ...
                <div
                  className={selected === 1 ? 'accordion__content show' : 'accordion__content'}
                >
                  
                  <div className='accordion__form_wrapper'>
    <form ref={form}>
        <label>Card Number <small>(required)</small></label>
        <textarea className='textarea' name="message" placeholder=''/>

        <div className='cvv_expiry_checkout'>
            <div>
                <label>CVV <small>(required)</small></label>
                <textarea className='textarea' name="message" placeholder=''/>
            </div>
            <div>
                <label>Expiry date <small>(required)</small></label>
                <textarea className='textarea' name="message" placeholder=''/>
            </div>

        </div>
        
            <button type='submit' className='accordion__form-submit'>Pay ₦8040</button>
            ...
            <div className='accordionx'>
              <div className='itemxx'>
                ...
                <div
                  className={selected === 2 ? 'accordion__content show' : 'accordion__content'}
                >
                   <div className='accordion__form_wrapper'>
    <form ref={form}>
        <label>Card Number <small>(required)</small></label>
