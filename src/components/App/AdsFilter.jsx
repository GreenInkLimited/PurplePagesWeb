...
import { fetchAdsByCategory, fetchAdsByLocation, fetchBusinessesByRating } from '../../apis/FilterApis';
...
const AdsFilter = ({ setFilteredProducts }) => {
  ...
  setFilteredProducts([selectedBusiness]); // Update the filtered products state
} else {
