...
const Reviews = () => {
  ...
  const { data: business, isLoading } = useQuery('business', () => getBusinessById({ id }));
...
const numFiveRatings = reviews.filter(review => review.rating === '5').length;
const numFourRatings = reviews.filter(review => review.rating === '4').length;
const numThreeRatings = reviews.filter(review => review.rating === '3').length;
const numTwoRatings = reviews.filter(review => review.rating === '2').length;
const numOneRatings = reviews.filter(review => review.rating === '1').length;
  ...
  return (
        <div className="review__container">
            ...
            <div className="review__top__right">
                <h3>{averageRating}<span>/5</span></h3>
                ...
                <p>Based on {numReviews} {numReviews === 1 ? 'verified user' : 'verified users'} </p>
            ...
            <div className="progress_content">
                ...
                <div className='on_the_right'><small>{numFiveRatings}</small></div>
            </div>
            <div className="progress_content">
                <div className='on_the_left'>
                    <small>4</small>  
                ...
                <div className='on_the_right'><small>{numFourRatings}</small></div>
                </div>
                <div className="progress_content">
                <div className='on_the_left'>
                    <small>3</small>  
                ...
                <Progress done={percentageThreeRatings}/>
                 <div className='on_the_right'><small>{numThreeRatings}</small></div>
                </div>
                <div className="progress_content">
                <div className='on_the_left'>
                    <small>2</small>  
                ...
                <Progress done={percentageTwoRatings}/>
                 <div className='on_the_right'><small>{numTwoRatings}</small></div>
                </div>
                <div className="progress_content">
                <div className='on_the_left'>
                    <small>1</small>  
                ...
                <Progress done={percentageOneRatings}/>
                 <div className='on_the_right'><small>{numOneRatings}</small></div>
                </div>
                </div>
            </div>
